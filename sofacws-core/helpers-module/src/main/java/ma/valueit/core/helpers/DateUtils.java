...
/**
 * Created by valueit-mac-yelansari on 8/24/17.
 */
public class DateUtils {
    ...
    public static Date stringTODateISO8601(String v) throws Exception {
        return dateISO8601Format.parse(v);
    }

    public static String toSimpleDateISO8601(Date v) throws Exception {
